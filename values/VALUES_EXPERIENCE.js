const VALUES_EXPERIENCE = [
    ...
    },
    {
        ...
        description: [
            ...
            [
                "Practicas fueron parte del Programa \"Honeywell Summer Intership.\"",
                "Trabaje con el equipo DevOps de Mexicali recolectando los requerimientos y documentación para una nueva version de un sistema de seguimiento de autorizacion de trabajos."
            ]
        ]
    }
];

export default VALUES_EXPERIENCE;